...
# ═══════════════ Path ═══════════════
CHECKPOINT_DIR = os.path.join(os.getcwd(), "Modelo_UNet")
TEST_OUT_DIR   = os.path.join(os.getcwd(), "Test_Nopal_UNet")
os.makedirs(CHECKPOINT_DIR, exist_ok=True)
os.makedirs(TEST_OUT_DIR,   exist_ok=True)

# ═════════════════════ Fine-Tuning ═════════════════════
FT_DIR_UNET = os.path.join(os.getcwd(), "FT_DIR_UNet")
os.makedirs(FT_DIR_UNET, exist_ok=True)

...
# ───────────────── dataset (Opuntia spp.) ─────────────────
DATA_DIR = os.path.join(os.getcwd(), "/lustre/home/rchandraghosh/Semantic-Segmentation-in-Orthomosaics-main/Dataset_Nopal")
...
TEST_IMAGES_DIR  = os.path.join(DATA_DIR, "Test", "Images_Aumentada")          # (no usado en este script)
TEST_MASKS_DIR   = os.path.join(DATA_DIR, "Test", "Masks_binaria_Aumentada")   # (no usado en este script)

# ──────────────── maguey ─────────────
DATA_DIRM        = os.path.join(os.getcwd(), "/lustre/home/rchandraghosh/Semantic-Segmentation-in-Orthomosaics-main/Dataset_Maguey")
...
OUT_DIR = os.path.join(os.getcwd(), "Modelos_Mask2Former")
